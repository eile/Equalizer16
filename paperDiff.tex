...
%DIF ADD paperIEEE.tex     Sun Aug 12 12:24:23 2018
...
for shared rendering nodes in virtualized enviroments. For this scenario \DIFdelbegin \DIFdel{tile
equalizer }\DIFdelend \DIFaddbegin \DIFadd{\textsf{tile\_equalizer} }\DIFaddend seems best suited, as it performs load balancing implicitly and does
not assume coherence of available resources between frames. The simpler tree
equalizer also outperforms the \DIFdelbegin \DIFdel{load equalizer }\DIFdelend \DIFaddbegin \DIFadd{\textsf{load\_equalizer} }\DIFaddend in this experiment.
