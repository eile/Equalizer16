...
rendering framework and summarized the work in parallel rendering. Since then,
...
decompose the work for a single pixel, for example when using FSAA or depth of
...
time between swaps. This is regularly used for time-multiplexed decompostions,
