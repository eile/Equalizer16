...
threads asynchronously, as outlined in \sref{SEC_threading}. The output frame
...
compound {
  ...
  inputframe { name "frame" }
    ...
    \end{lstlisting}}
    \caption{\label{eqc:dplex}Time-Multiplex}
  \end{subfigure}
  \begin{subfigure}[b]{0.24\textwidth}
    {\tiny\begin{lstlisting}
compound {
...
compound {
  ...
  inputframe { name "frame.source" }
    ...
    \end{lstlisting}}
    \caption{\label{eqc:subpixel}Subpixel}
  \end{subfigure}
  \caption{Compound configurations for \fig{fig:compounds}}
  \label{eqc:compounds}
\end{figure*}
