...
which has shown to by sufficient for this use case. Queues are distrbuted, single producer,
multiple consumer FIFO queues. To hide network latencies, consumers prefetch
