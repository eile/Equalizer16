...
\author{Stefan~Eilemann\thanks{email: eilemann@gmail.com},
        ...
        and~Renato~Pajarola\thanks{email: pajarola@ifi.uzh.ch},~\IEEEmembership{Senior Member,~IEEE}%
...
sort-last rendering, respectively. They are implemented via the
\textsf{tile\_equalizer} and \textsf{chunk\_equalizer} compounds, which
decompose the scene into a predefined set of fixed-size image tiles or database
ranges, respectively. The resulting tasks, or work packages, are queued and
...
improves performance over a static allocation.
...
unfavorably assigned under such conditions. For our polygonal rendering setup,
...
Stefan Eilemann} works on large data visualization and parallel rendering. He
...
in Computer Science from EPFL in 2015, and an Engineering Diploma in Computer
Science in 1998. He is working towards a PhD in Computer Science at the
