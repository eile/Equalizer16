...
\begin{figure}[ht]\center
  ...
  \caption{\label{fBenchmarkEVolve} Flower alley with 30 volume models of $1024^3$ unsigned bytes (1GB) each.}
\end{figure}

\begin{figure}[ht]\center
  \includegraphics[width=.9\columnwidth]{images/benchmark_eqPly2}
  \caption{\label{fBenchmarkEqPly} David alley with 30 statues of 56m triangles (988MB) each.\FIXME{check the triangle count}}
\end{figure}
