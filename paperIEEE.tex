...
\begin{figure*}[ht]\center
  \subfigure[Load-Balancing]{\label{fig:loadeq}
    \includegraphics[width=0.24\textwidth]{images/loadeq}}\hfil
  \subfigure[Cross-Segment Load-Balancing]{\label{fig:vieweq}
    \includegraphics[width=0.24\textwidth]{images/vieweq}}\hfil
  \subfigure[Dynamic Frame Resolution]{\label{fig:dfr}
    \includegraphics[width=0.24\textwidth]{images/dfr}}\hfil
  \subfigure[Monitoring]{\label{fig:monitor}
    \includegraphics[width=0.24\textwidth]{images/monitoreq}}\hfil
