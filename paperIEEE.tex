...
oscillation behaviour \FIXME{due to @David?}.
...
distribution is more justified. The relative simple nature of our benchmark
...
\begin{figure*}[ht]\center
  ...
  simulation at 512x437x240 unsigned byte (51\,MB) and an MicroCT scan of a
  beechnut at 1024x1024x1546 unsigned short (3\,GB) resolution}
\end{figure*}
