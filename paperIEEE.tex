...
rendering cluster using hexacore Intel Xeon E5-2620v3 CPUs (2.4\,GHz), 16\,GB DDR4 RAM per node, nVidia GTX 970 GPUs with 4\,GB VRAM each, and QDR Infiniband.
...
data is beneficial for transmitting data over a 10\,Gb/s %why was there a tilde inbetween? Should this be ~10Gb/s instead?
