...
algorithms, from very fast run-length encoding and YUV subsampling on the GPU to JPEG
...
for virtualized enviroments. For this scenario tile equalizer seems best suited,
