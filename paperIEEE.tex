...
resolution (\fig{fDavid2mm}) and 3D volumes of a spike frequencies of a 3
million neuron simulation (\fig{fVolumes}).

\begin{figure}[ht]\center
  \includegraphics[width=.49\columnwidth]{images/spikes512}\hfil
  \includegraphics[width=.49\columnwidth]{images/spikes1280}
  \caption{\label{fVolumes}Spike frequencies of a 3 million neuron simulation at
