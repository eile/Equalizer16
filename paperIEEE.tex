...
\begin{figure}[ht]\center
  ...
  \caption{\label{fBenchmarkEqPly} David alley with 30 statues of 56m triangles (988\,MB) each.\FIXME{check the triangle count}}
\end{figure}
...
data is beneficial for transmitting data over a 10~Gb/s \FIXME{~10\,Gb/s ?} link even for a single
...
rates of 3.7~GB/s \FIXME{~3.7\,GB/s ?} with the default Snappy compressor and at best 4.4~GB/s \FIXME{~4.4\,GB/s ?} with
