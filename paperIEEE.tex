...
% Furthermore, subpixel compounds interact with idle image refinements, e.g., they
% can accelerate idle anti-aliasing of a scene when the camera and scene are not
% changed.
