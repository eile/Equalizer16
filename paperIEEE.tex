...
for new research in visualization, such as \textsf{RTNeuron}~\cite{HBBES:13}, an
OpenGL renderer for visualizing simulations of neurocortical brain regions;
\textsf{Omegalib}~\cite{Omegalib}, a framework used in the Cave2, extending
\textsf{Equalizer} for hybrid collaborative 2D/3D environments;
