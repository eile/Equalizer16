...
distribute data. Last, but not least, view data provides a convenient way to
manage multiple views by storing the camera, model or any other view-specific
information.
...
stereo (EYE) decomposition \cite{EMP:09}. In the following we present new
decomposition modes and motivate their use case.
