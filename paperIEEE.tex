...
\FIXME{Highlight integration of many features into a general framework vs
one-off research implementation of one algorithm. Also point out the various and
very diverse examples in Section 7, highlighting the variety of application and
implementation scenarios that can benefit from \textsf{Equalizer}.}
