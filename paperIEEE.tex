...
The volume data sets are each distributed in a single object, serializing the
...
default Snappy compressor and at best 4.4 GB/s with ZStandard at the lowest
compression ratio.
...
compression engines is consisten with the benchmarks in
...
\FIXME{Missing: david on 10GE, spike comparisoon 10GE-IB-RSP}
